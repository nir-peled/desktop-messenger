...
macro_rules! Settings {
	($($field:ident : $t:ty),* $(,)? ) => {
		...
		impl Settings {
			...
			fn line_parts(line: Result<String, std::io::Error>) -> Result<(String, String), SettingsReadError> {
				let line_value = line?;
